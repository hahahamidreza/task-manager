...
function db_insert2($table_name, $input_array)
{
    $conn = db_conn();
    $keys_string = '';
    $values_string = '';
    ...
    $sql = "INSERT INTO `$table_name` ($keys_string) VALUES ($values_string) WHERE `user_id` = ($user_id)";
    $result = mysqli_query($conn, $sql);
    return $result;
}
